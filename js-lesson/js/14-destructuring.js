...
const displayAvengers = document.querySelector('#display-avenger');

displayAvengers.addEventListener('click', function () {
    const cardsAvengers = document.querySelectorAll('.card-hero');
    for (let cardAvenger of cardsAvengers) {
        cardAvenger.remove();
    }
